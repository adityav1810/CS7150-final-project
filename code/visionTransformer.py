...
class Embeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        # Create position and patch embeddings for the [CLS] token dont forget to add 1
    ...
    def forward(self, x):
        ...
        # ADD [CLS] to the beginning of the input sequence
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, config):
        ...
        #  project the encoder's output to the number of classes
